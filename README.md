...
## Доступна новая версия Keen DPI: 2024.11.12 🎉 

## Что нового:

1. Переписано правило для UDP.
2. Адаптированы новые аргументы.
3. Исправлен старт службы.
4. В алгоритм добавлена стратегия заглушка, для тех у кого провайдер не ограничивает YouTube.
5. Вернул поддержку IPv6.
